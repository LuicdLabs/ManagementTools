    ...
    public partial class App : Application
    {
        ...
        private async void ShowErrorDialog(Exception ex)
        {
            ...
            if (MainWindowInstance?.Content is FrameworkElement frameworkElement)
            {
                ...
                try
                {
                    var localized = OneMMC.Localization.LocalizedStrings.Instance;
        ...
        protected override void OnLaunched(Microsoft.UI.Xaml.LaunchActivatedEventArgs args)
        {
            ...
            OneMMC.Localization.UILocalizationProvider.InitializeCoreLocalization();

            // Initialize UI-thread marshaling for PerformanceCounterInfo without exposing WinUI types to Core.
            var dispatcherQueue = Microsoft.UI.Dispatching.DispatcherQueue.GetForCurrentThread();
            OneMMC.Core.Features.PCManagement.Models.PerfMon.PerformanceCounterInfo.InitializeDispatcher(action =>
            {
